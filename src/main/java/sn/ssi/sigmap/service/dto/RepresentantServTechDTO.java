...
/**
 * A DTO for the {@link sn.ssi.sigmap.domain.RepresentantServTech} entity.
 */
@ApiModel(description = "TABLE RepresentantsServicesTechnique")
public class RepresentantServTechDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RepresentantServTechDTO)) {
            return false;
        }

        return id != null && id.equals(((RepresentantServTechDTO) o).id);
    }
    ...
    public String toString() {
        return "RepresentantServTechDTO{" +
            "id=" + getId() +
